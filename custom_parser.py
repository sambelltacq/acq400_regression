...
def get_default_parser():
    parser = CustomParser(description='acq400_regression default argparser', conflict_handler='resolve')
    ...
    parser.add_argument('--channels', type=parser.list_of_channels, default=[1], help=f"Channels to test 1,2,3,4 or all")
